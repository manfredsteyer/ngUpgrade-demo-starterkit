System.register(['angular2/core', '../services/passagier-service', '../services/warenkorb-service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, passagier_service_1, warenkorb_service_1;
    var PassagierSuchen;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            PassagierSuchen = (function () {
                function PassagierSuchen(passagierService, // AngularJS 1.x
                    warenkorbService) {
